...
import 'package:myapp/pages/navigation_page.dart';
...
class _Record extends State<Record> with AutomaticKeepAliveClientMixin {
  BluetoothState _bluetoothState =
      BluetoothState.UNKNOWN; //definimos el estado inicial como unknown
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(
                    top: 35.0, bottom: 20.0, left: 35.0, right: 35.0),
                child: Column(
                  children: [
                    const Center(
                      child: Icon(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            onPressed: (newRecButton == true)
                                ? () async {
                                    await showPainLevelDialog(
                            ...
                            child: Text(
                              'NEW RECORDING',
                              style: TextStyle(
                                color: (newRecButton == true)
                                    ? Colors.white
                                    : Colors.grey[550], // Change the text color
                                fontSize: 15.0,
                                letterSpacing: 2.0,
                                fontWeight: FontWeight.bold,
                              ),
                      ...
                      //
                      // Text(
                      //   timerButton ? timerProvider.formatTime() : '00:00:00.00',
                      //   style: TextStyle(
                      //     color: timerButton ? Colors.grey[700] : Colors.white,
                      //     letterSpacing: 2.0,
                      //     fontSize: 40.0,
                      //   ),),

                      if (((painLevel == 10) || (painLevel >= 9 &&
                          actualUser.prevPreg != '0')) && (startButton)) ...[
                        Padding(
                        ...
                        Text(
                          'Due to your pain level, suggestion:',
                          style: TextStyle(
                            color: Color(0xFF4A2574),
                            letterSpacing: 1.5,
                            fontStyle: FontStyle.italic,
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color:
                                timerButton ? Colors.grey[700] : Colors.white,
                            letterSpacing: 2.0,
                            fontSize: 40.0,
                          ),
                        ),
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Icon(Icons.play_arrow_rounded,
                                      size: 40.0,
                                      color: startButton ? Colors.white : null),
                                  onPressed: (startButton == true)
                                      ? () async {
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Icon(Icons.stop_rounded,
                                      size: 40.0,
                                      color: stopButton ? Colors.white : null),
                                  onPressed: (stopButton == true)
                                      ? () async {
                                          timerProvider.stop();
  ...
  Future<void> saveCSVFile(
      List<double> csvData, int painLevel, String duration) async {
    ...
    final file =
        File('${directory?.path}/${DateTime.now()} - Medicion EHG.csv');
